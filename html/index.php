            ...
            <section class="results">
                <div class="results__content">
                    ...
                    <ul class="why-pain__list results__list">
                        <li class="uslugi__block-describe">— Часто становится заметно легче уже после первого приёма</li>
                        <li class="uslugi__block-describe">— Возвращается уверенное, свободное движение</li>
                        <li class="uslugi__block-describe">— Увеличивается сила и выносливость без дополнительных нагрузок</li>
                        <li class="uslugi__block-describe">— Исчезает «защита тела» — спазмы, скованность, блоки</li>
                        <li class="uslugi__block-describe">— Восстанавливается контроль движений — при занятиях спортом, на тренировках, в обычной жизни</li>
                    </ul>

                    <div class="results__blocks">
                        <div class="uslugi__block">
                            <h2 class="uslugi__block-title">Как мы оцениваем результат</h2>
                            <p class="uslugi__block-describe">Результат коррекции определяется не только по самочувствию клиента, а по восстановлению нормальной рефлекторной активности и способности системы удерживать функцию под нагрузкой. Окончательная оценка устойчивости результата проводится по завершении адаптационного периода — до 12 недель, когда нервная система завершает перестройку и закрепляет новые паттерны управления. Если по истечении этого периода: миотатический рефлекс восстановлен, показатели стабильны, тело удерживает результат между визитами, — работа считается выполненной.</p>
                        </div>

                        <div class="uslugi__block">
                            <h2 class="uslugi__block-title">Ключевой принцип</h2>
                            <p class="uslugi__block-describe">Мы оцениваем результат по работе нервно-мышечной системы, а не только по субъективным ощущениям. Именно поэтому наши услуги выстроены вокруг диагностики, коррекции и контроля рефлекторного управления с возможностью объективной оценки динамики восстановления.</p>
                        </div>
                    </div>
