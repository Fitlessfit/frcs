...
<html lang="ru">
    <head>
		...
		<link rel="stylesheet" href="assets/css/style.css?v=1.76">
		<link rel="stylesheet" href="assets/css/adaptive.css?v=3.1">
		<style>
            ...
            <section class="results" id="results">
                <div class="results__content">
                    ...
                    <div class="results__cards">
                        ...
                        <div class="uslugi__block">
                            <h2 class="uslugi__block-title">Рост<br class="br-desktop">показателей</h2>
                            <p class="uslugi__block-describe">Сила и выносливость без доп. нагрузок</p>
                        </div>
                        <div class="uslugi__block">
                            <h2 class="uslugi__block-title">Снятие защиты<br class="br-desktop">тела</h2>
                    ...
                    <div class="results__blocks">
                        <div class="uslugi__block">
                            <h2 class="results__block-title">Как мы оцениваем результат</h2>
                            <p class="uslugi__block-describe">Результат коррекции определяется по восстановлению нормальной рефлекторной активности и способности системы удерживать функцию под нагрузкой. Адаптационный период — до 12 недель. В это время нервная система завершает перестройку и закрепляет новые паттерны управления.</p>
                            <p class="uslugi__block-describe" style="margin-top:14px;">Работа считается выполненной, если:</p>
                            <ul class="why-pain__list" style="margin-top:10px;">
                                <li class="uslugi__block-describe">— Миотатический рефлекс восстановлен</li>
                                <li class="uslugi__block-describe">— Показатели стабильны и не «откатываются»</li>
                ...
                <div class="faq__content">
                    ...
                    <div class="faq__grid">
                        ...
                        <details class="faq__item">
                            ...
                            <p class="faq__answer">Мы используем <strong>объективные критерии</strong>: восстановление устойчивого миотатического рефлекса. Даже если боль уходит постепенно, восстановленный рефлекс — это гарантия того, что система работает правильно.</p>
                        </details>
                        ...
                        <details class="faq__item">
                            ...
                            <p class="faq__answer">Приём длится до достижения положительного теста рефлекса мышечного сокращения в зоне основной жалобы. Продолжительность визита обычно составляет от <strong>45 до 90 минут</strong>. Этот интервал используется как временной слот для записи. Стоимость уточняйте при записи: она зависит от формата работы (очно / онлайн) и сложности запроса.</p>
                        </details>
